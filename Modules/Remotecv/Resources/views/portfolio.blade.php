        ...
        <section class="portfolio padding-top-50 padding-bottom-50"> 
            ...
            <article class="portfolio-item mix  design photo visual">
                <div class="portfolio-image"> 
                    <a href="#."> 
                        <img class="img-responsive" alt="Open Imagination" src="images/portfolio/5/img-1.jpg"> 
                    </a>
            ...
            <article class="portfolio-item mix brand  photo ">
                <div class="portfolio-image"> 
                    <a href="#."> 
                        <img class="img-responsive" alt="Open Imagination" src="images/portfolio/5/img-2.jpg"> 
                    </a>
                <div class="portfolio-overlay style-4">
                    <div class="detail-info">
                    <div class="position-center-center">
            ...
            <article class="portfolio-item mix  photo visual">
                <div class="portfolio-image"> 
                    <a href="#."> 
                        <img class="img-responsive" alt="Open Imagination" src="images/portfolio/5/img-3.jpg"> 
                    </a>
                <div class="portfolio-overlay style-4">
                    <div class="detail-info">
                    <div class="position-center-center">
            ...
            <article class="portfolio-item mix  design  visual ">
                <div class="portfolio-image"> 
                    <a href="#."> 
                        <img class="img-responsive" alt="Open Imagination" src="images/portfolio/5/img-4.jpg"> 
                    </a>
                <div class="portfolio-overlay style-4">
                    <div class="detail-info">
                    <div class="position-center-center">
            ...
            <article class="portfolio-item mix brand  photo ">
                <div class="portfolio-image"> 
                    <a href="#."> 
                        <img class="img-responsive" alt="Open Imagination" src="images/portfolio/5/img-5.jpg"> 
                    </a>
                <div class="portfolio-overlay style-4">
                    <div class="detail-info">
                    <div class="position-center-center">
            ...
            <article class="portfolio-item mix brand ">
                <div class="portfolio-image"> 
                    <a href="#."> 
                        <img class="img-responsive" alt="Open Imagination" src="images/portfolio/5/img-9.jpg"> 
                    </a>
                <div class="portfolio-overlay style-4">
                    <div class="detail-info">
                    <div class="position-center-center">
            ...
            <article class="portfolio-item mix  photo visual">
                <div class="portfolio-image"> 
                    <a href="#."> 
                        <img class="img-responsive" alt="Open Imagination" src="images/portfolio/5/img-7.jpg"> 
                    </a>
                <div class="portfolio-overlay style-4">
                    <div class="detail-info">
                    <div class="position-center-center">
            ...
            <article class="portfolio-item mix brand design visual">
                <div class="portfolio-image"> 
                    <a href="#."> 
                        <img class="img-responsive" alt="Open Imagination" src="images/portfolio/5/img-8.jpg"> 
                    </a>
                <div class="portfolio-overlay style-4">
                    <div class="detail-info">
                    <div class="position-center-center">
