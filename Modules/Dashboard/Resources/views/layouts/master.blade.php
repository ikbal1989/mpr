...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>IBR</b>SOFTWARE</span>
        </a>
...
<!-- Morris.js charts -->
{{ Html::script($assetspath.'/bower_components/raphael/raphael.min.js') }}
{{ Html::script($assetspath.'/bower_components/morris.js/morris.min.js') }}
<!-- Sparkline -->
{{ Html::script($assetspath.'/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}
<!-- jvectormap -->
{{ Html::script($assetspath.'/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}
{{ Html::script($assetspath.'/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}
<!-- jQuery Knob Chart -->
{{ Html::script($assetspath.'/bower_components/jquery-knob/dist/jquery.knob.min.js') }}
<!-- daterangepicker -->
{{ Html::script($assetspath.'/bower_components/moment/min/moment.min.js') }}
{{ Html::script($assetspath.'/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}
<!-- datepicker -->
{{ Html::script($assetspath.'/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}
<!-- Bootstrap WYSIHTML5 -->
{{ Html::script($assetspath.'/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}
<!-- Slimscroll -->
{{ Html::script($assetspath.'/bower_components/jquery-slimscroll/jquery.slimscroll.min.js') }}
<!-- FastClick -->
{{ Html::script($assetspath.'/bower_components/fastclick/lib/fastclick.js') }}
<!-- AdminLTE App -->
